...
download.file(fileUrl,destfile="/home/sagar/Dataset.zip")

# extract the files

unzip(zipfile = "/home/sagar/Dataset.zip")


## Read .txt files into R
# readme files identifies which files should be used in dataset

activitytest  <- read.table("/home/sagarUCI HAR Dataset/test/Y_test.txt",header = FALSE)
activitytrain  <- read.table("/home/sagar/UCI HAR Dataset/train/Y_train.txt",header = FALSE)
subjecttrain <- read.table("/home/sagar/UCI HAR Dataset/train/subject_train.txt",header = FALSE)
subjecttest <- read.table("/home/sagar/UCI HAR Dataset/test/subject_test.txt",header = FALSE)
featurestest  <- read.table("/home/sagar/UCI HAR Dataset/test/x_test.txt",header = FALSE)
featurestrain  <- read.table("/home/sagar/UCI HAR Dataset/train/x_train.txt",header = FALSE)
...
featuresnames <- read.table("/home/sagar/UCI HAR Dataset/features.txt",header = FALSE)
...
activitylabels <- read.table("/home/sagar/UCI HAR Dataset/activity_labels.txt", header = FALSE)
